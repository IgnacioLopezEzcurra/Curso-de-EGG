...
public class Persona {
    ...
    public Persona crearPersona() {
        ...
        System.out.println("Usted esta por crear un nuevo objeto Persona");
        System.out.println("Ingrese su nombre: ");
        this.nombre = leer.nextLine();
        System.out.println("Ingrese su edad");
        this.edad = leer.nextInt();

        leer.nextLine(); // Se reinicia la memoria bufer. Reiniciar el buffer de lectura
        ...
        do {
            ...
            if (!sexo.equals("H") && !sexo.equals("M") && !sexo.equals("O")) {
                System.out.println("Error, ha ingresado un valor incorrecto");
                System.out.println("Recuerde que el sistema acepta solo H, M u O");
            }
