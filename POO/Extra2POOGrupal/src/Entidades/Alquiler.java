...
public class Alquiler {
    ...
    public Alquiler(String peliculaAlquilada, double precio, LocalDate fechaInicio, LocalDate fechaFin) {
    ...
    public String toString() {
        return "Alquiler{" + "peliculaAlquilada=" + peliculaAlquilada + ", precio=" + precio + ", fechaInicio=" + fechaInicio + ", fechaFin=" + fechaFin + '}';
    }
