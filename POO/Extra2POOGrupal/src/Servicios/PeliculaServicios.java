...
public class PeliculaServicios {
    ...
    public Pelicula crearPelicula() {
        ...
        return new Pelicula(titulo, genero, anio, duracion, disponibilidad);

    }

    public void listarPelicula(Pelicula[] listaPeli) {

        for (int i = 0; i < listaPeli.length; i++) {

            if (listaPeli[i].isDisponibilidad()) {
                System.out.println((i+1) + ". " + listaPeli[i].toString());
            }
