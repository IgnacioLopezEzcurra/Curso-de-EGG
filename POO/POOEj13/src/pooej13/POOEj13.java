...
//        cs.cargarAlumnos(c1.getAlumnos()); viejo metodo que hubiera utilizado si no me pedia llamar cargar alumnos dentro de crearcurso
        System.out.println(Arrays.toString(c1.getAlumnos()));
        System.out.println("La ganancia semanas es " + cs.calcularGananciaSemanal(c1));
    }
