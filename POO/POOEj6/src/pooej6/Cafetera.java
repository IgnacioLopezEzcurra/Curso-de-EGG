...
public class Cafetera {
    ...
    public void servirTaza(int tamañoTaza) {
        ...
        if (this.cantidadActual < tamañoTaza) {
            tamañoTaza = tamañoTaza - this.cantidadActual;
            this.cantidadActual = 0;
            System.out.println("La taza no se lleno y quedo en " + tamañoTaza);
        } else {
            this.cantidadActual = this.cantidadActual - tamañoTaza;
            System.out.println("La taza se lleno y le queda " + cantidadActual + " de cafe.");
        }
