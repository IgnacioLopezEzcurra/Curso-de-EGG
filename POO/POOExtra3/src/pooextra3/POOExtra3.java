...
public class POOExtra3 {
    ...
    public static void main(String[] args) {
        ...
        Raices r1 = rs.crearObjeto();
        System.out.println(r1);
        System.out.println("El discriminante es " + rs.getDiscriminante(r1));

        System.out.println("");
        System.out.println("Tiene dos soluciones?: " + rs.tieneRaices(r1));

        System.out.println("");
        System.out.println("Tiene una unica solucion?: " + rs.tieneRaiz(r1));
        ...
        System.out.println("");
        System.out.println("---APLICANDO METODO CALCULAR---");
        rs.calcular(r1);
