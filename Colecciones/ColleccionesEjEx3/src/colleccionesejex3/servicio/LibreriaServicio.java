 ...
 */
package colleccionesejex3.servicio;
...
public class LibreriaServicio {
    ...
    public boolean prestamo(HashSet<Libro> listaLibro) {
        ...
        for (Libro libro : listaLibro) {
            ...
            if(libro.getTitulo().equalsIgnoreCase(busqueda) && libro.getNumEjemplares() >= 1){
    ...
    public boolean devolucion(HashSet<Libro> listaLibro) {
